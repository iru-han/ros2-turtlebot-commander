# [기능 명세서] 터틀봇3 GUI 제어 및 지능형 순찰 시스템
...
- **Mode OFF**: 장애물 경고는 표시하되, 사용자의 명령에 따른 강제 주행 허용.  
...
## 6. 결론 및 기대 효과
본 시스템은 ROS 2의 분산 컴퓨팅 환경에서 발생할 수 있는 데이터 동기화 문제와 데드락 문제를 해결하기 위해 Callback Group 및 MultiThreadedExecutor를 적용하였습니다. 이를 통해 높은 안정성을 가진 로봇 제어 인터페이스를 구축하였으며, 향후 Nav2(Navigation) 패키지와의 통합을 위한 기초 구조를 마련하였습니다.
